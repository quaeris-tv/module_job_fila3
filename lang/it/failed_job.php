...
return [
    ...
    'fields' => [
        'id' => ['label' => 'ID'],
        'uuid' => ['label' => 'UUID'],
        'connection' => ['label' => 'Connessione'],
        'queue' => ['label' => 'Coda'],
        'payload' => ['label' => 'Payload'],
        'exception' => ['label' => 'Eccezione'],
        'failed_at' => ['label' => 'Fallito il'],
        'attempts' => 'Tentativi',
    ...
    'actions' => [
        'retry' => [
            ...
            'messages' => ['success' => 'Job riavviato con successo'],
        ],
        'retry_all' => [
            'label' => 'Riprova Tutti',
            'modal' => [
        ...
        'delete' => [
            ...
            'messages' => ['success' => 'Job eliminato con successo'],
        ],
        'delete_all' => [
            'label' => 'Elimina Tutti',
            'modal' => [
            ...
            'messages' => ['success' => 'Jobs eliminati con successo'],
        ],
        'clear' => [
            'label' => 'Pulisci Tutto',
            'modal' => [
            ...
            'messages' => ['success' => 'Jobs falliti eliminati con successo'],
        ],
    ],
    'messages' => [
